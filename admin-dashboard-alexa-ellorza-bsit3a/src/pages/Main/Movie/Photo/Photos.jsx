      ...
      <div className='p-photo-search-box'>
        <div className='p-parent-container'>
          <div className='p-photo-detail-box'>
            <div className='p-photo-container-center'>
              <div className='p-photo-image-container'>
                <img
                  alt='photo-movies'
                  src={selectedphoto.url
                    ? selectedphoto.url
                    : require('./../../../../images/image_default.jpg')
                  }
          ...
          <div className='p-photo-info-text'>
          ...
          <div className='save-edit-back-btn'>
            {!photoid ? (
              <>
                <button className='p-edit-save-btn '
                  type='button'
                  onClick={handlesave}
                >
                  Save
