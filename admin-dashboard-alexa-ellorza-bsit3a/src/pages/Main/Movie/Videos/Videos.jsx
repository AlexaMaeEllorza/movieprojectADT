...
function VideoForm() {
  ...
  return (
    <div className='v-video-box'>
      <div className='v-video-search-box'>
        <div className='v-parent-container'>
          <div className='v-video-detail-box'>
            <div className='v-video-container-center'>
              <div className='v-video-frame-container'>
                <iframe
          ...
          <div className='v-video-info-text'>
      ...
      <div className='v-video-view-box'>
        {videos !== undefined && videos.length > 0 ? (
          <div className='v-card-display-videos'>
            {videos.map((items) => (
              <div key={items.id} className='v-card-video'>
                <div className='v-buttons-group'>
                  <button
                    type='button'
                    className='v-delete-button'
